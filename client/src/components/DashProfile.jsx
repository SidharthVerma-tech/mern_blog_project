...
export default function DashProfile() {
    ...
    const uploadImage = async () => {
        ...
        uploadTask.on(
            ...
            (error)=>{
                setImageFileUploadError('Could not upload Image (File mus be less than 2 MB)')
...
<Alert color='failure'>{imageFileUploadError}
        ...
        {updateUserError && <Alert color='success' className='mt-5'> 
            {updateUserError}
            </Alert>
        }
         {error && <Alert color='success' className='mt-5'> 
            {error}
            </Alert>
        }
